...
namespace RestV2.Manager
{
    public class PairMusikManager
    {
        ...
        private const string ConnectionString =
            @"Data Source=(localdb)\MSSQLLocalDB;Initial Catalog = PairProgrammingMusik; Integrated Security = True; Connect Timeout = 30; Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";
        //Patrick
        //@"";
        ...
        private const String GETALL = "SELECT * FROM PairMusik";
        private const String GETONE = "SELECT * FROM PairMusik WHERE Kontrol_Nr = @ID";
